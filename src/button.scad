                   ...
                   anchor = CENTER, spin = 0, orient = UP)
{
  ...
  actual_spacing = use_minimal_spacing ? [ minimal_spacing, minimal_spacing ] : spacing;

  total_x = (n[0] - 1) * actual_spacing[0] + button_hole_width +
            (show_fasteners_x ? button_fastener_thickness * 2 : grid_margin_to_edge * 2);
  total_y = (n[1] - 1) * actual_spacing[1] + button_hole_length +
  ...
  attachable(anchor = anchor, spin = spin, orient = orient, size = size)
  {
    ...
    {
      grid_copies(n = n, spacing = actual_spacing)
      {
                          ...
                          orient = UP)
{
  ...
  actual_spacing = use_minimal_spacing ? minimal_spacing : spacing;

  total_x = (n[0] - 1) * actual_spacing[0] + button_hole_width + grid_margin_to_edge * 2;
  total_y = (n[1] - 1) * actual_spacing[1] + button_hole_length + grid_margin_to_edge * 2;
